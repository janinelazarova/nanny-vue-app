                  ...
                  <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody>
                      <tr v-for="booking in orderBy(filterBy(nanny.bookings, nameFilter), sortAttribute)">
                        ...
                        <td class="align-middle text-muted">
                          <span class="text-pink d-block font-weight-bold font-size-18 mb-2">{{ booking.price + '$ / per booking' }}</span>
                        </td>
                        <td class="align-middle text-muted">
              ...
              <!--   <div class="row">
                  ...
                  <div v-for="booking in nanny.bookings" class="col-xl-6">
                    <div class="media pricing-list bg-light mb-6">
                      <div class="pricing-plan bg-pink">
                        ...
                        <div class="">
                          <ul class="list-unstyled list-item-lg mb-0">
                            <li class="d-flex align-items-baseline mb-3">
                              <i class="fa fa-calendar mr-2 text-pink" aria-hidden="true"></i>
                              {{ booking.start_date }}
                            </li>
                            <li class="d-flex align-items-baseline mb-3">
                              <i class="fa fa-clock-o mr-2 text-pink" aria-hidden="true"></i>
                            ...
                            <li class="d-flex align-items-baseline mb-0">
                              <i class="fa fa-money mr-2 text-pink" aria-hidden="true"></i>
  ...
  created: function() {
    axios.get("/api/nannies/" + this.$route.params.id).then(response => {
      ...
      var popup = new mapboxgl.Popup({ offset: 25 })
          .setHTML(
            "<h4>Address: "+this.nanny.address+"</h4><br><h4>Phone: "+this.nanny.phone_number+"</h4>"
          )
